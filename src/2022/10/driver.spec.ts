...
describe('day 10', () => {
  describe('part 1', () => {
    it('can parse test inputs correctly', () => {
      const input = fs.readFileSync('./src/2022/10/test.txt', 'utf8');
    ...
    it('can parse input1 correctly', () => {
      const input = fs.readFileSync('./src/2022/10/input1.txt', 'utf8');
      const underTest = work(input);
      const expected = 12740;
      expect(underTest, 'should be identical').to.deep.equal(expected);
    });
  });
...
`;
    ...
    it('can parse input2 correctly', () => {
      const input = fs.readFileSync('./src/2022/10/input2.txt', 'utf8');
      const underTest = work2(input);
      const expected = `###..###..###...##..###...##...##..#####
#..#.#..#.#..#.#..#.#..#.#..#.#..#.#...#
#..#.###..#..#.#..#.#..#.#..#.#....###.#
